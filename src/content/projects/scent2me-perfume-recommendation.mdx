...
status: "Completed"
year: 2025
role: "Backend developer and deployment engineer"
stack:
  - FastAPI
  - Python
  - Scikit-learn
...
<figure className="evidence-panel" data-artifact="Landing artifact">
  <img src="/assets/projects/scent2me-perfume-recommendation/screenshots/01-home.webp" width="1400" height="826" loading="lazy" decoding="async" alt="Scent2Me homepage showing the perfume recommendation platform hero and navigation" />
  <figcaption>Frontend evidence: Scent2Me homepage deployed on Vercel with recommendation, explore, wishlist, and login navigation.</figcaption>
</figure>
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel" data-artifact="Preference flow">
    <img src="/assets/projects/scent2me-perfume-recommendation/screenshots/02-preferences.webp" width="1400" height="826" loading="lazy" decoding="async" alt="Scent2Me recommendation form with gender, fragrance family, time of day, occasion, favorite notes, and budget fields" />
    <figcaption>Preference flow: users describe scent family, usage context, performance, notes, and budget before requesting recommendations.</figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Recommendation output">
    <img src="/assets/projects/scent2me-perfume-recommendation/screenshots/03-results.webp" width="1400" height="826" loading="lazy" decoding="async" alt="Scent2Me recommendation results page showing perfume cards with ratings, notes, price, and save recommendation action" />
    <figcaption>Recommendation output: ranked perfume cards with notes, rating, price, product links, and wishlist-saving behavior.</figcaption>
  </figure>
</div>
