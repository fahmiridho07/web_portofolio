...
<figure className="evidence-panel" data-artifact="Forecast overview">
  <img src="/assets/projects/juanda-airport-visitor-forecasting/juanda_airport_forecasting_dashboard.svg" width="1440" height="920" loading="lazy" decoding="async" alt="Dashboard showing Juanda Airport visitor forecasting data, monthly trend, yearly average, and project metrics" />
...
<figure className="evidence-panel" data-artifact="Model comparison">
  <img src="/assets/projects/juanda-airport-visitor-forecasting/juanda_model_comparison.svg" width="1440" height="900" loading="lazy" decoding="async" alt="Model comparison for Juanda forecasting showing R2 and MAE across Linear Regression, Random Forest, and CNN-LSTM" />
