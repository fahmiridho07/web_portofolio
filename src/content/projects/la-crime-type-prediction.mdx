...
<figure className="evidence-panel">
  <img src="/assets/projects/la-crime-type-prediction/la_crime_prediction_dashboard.svg" alt="Los Angeles crime prediction dashboard showing raw records, modeled classes, balanced records, top crime types, day-night split, zones, and top areas" />
...
<div className="evidence-grid">
  <figure className="evidence-panel">
    <img src="/assets/projects/la-crime-type-prediction/ml_workflow_diagram.svg" alt="Machine learning workflow diagram covering data preparation, exploratory analysis, model experimentation, evaluation, and model selection" />
  ...
  <figure className="evidence-panel">
    <img src="/assets/projects/la-crime-type-prediction/la_model_comparison.svg" alt="Model comparison for LA Crime classification showing accuracy, F1, and AUC across tested models" />
