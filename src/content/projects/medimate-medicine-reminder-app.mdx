...
links: []
featured: false
coverImage: "/assets/projects/medimate-medicine-reminder-app/screenshots/01-home.png"
...
<div className="phone-gallery">
  <figure>
    <img src="/assets/projects/medimate-medicine-reminder-app/screenshots/01-home.png" alt="MediMate home screen showing medicine list, search field, and add medicine button" />
    <figcaption>Home screen with searchable medicine list.</figcaption>
  </figure>
  <figure>
    <img src="/assets/projects/medimate-medicine-reminder-app/screenshots/02-add-medicine.png" alt="MediMate add medicine form with name, dosage, time, image, cancel, and save controls" />
    <figcaption>Add/edit form with dosage, time, and image fields.</figcaption>
  </figure>
  <figure>
    <img src="/assets/projects/medimate-medicine-reminder-app/screenshots/03-detail-medicine.png" alt="MediMate medicine detail screen showing selected medicine information and actions" />
