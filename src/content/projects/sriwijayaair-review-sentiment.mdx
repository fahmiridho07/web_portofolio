...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel" data-artifact="Model comparison">
    <img
      src="/assets/projects/sriwijayaair-review-sentiment/model-performance.webp"
      width="1400"
      height="540"
      loading="lazy"
      decoding="async"
      alt="Bar charts comparing Logistic Regression, Linear SVM, and Naive Bayes on accuracy, macro F1, and weighted F1, plus per-class F1 for the best model"
    />
    <figcaption>
      Logistic Regression won on macro F1; per-class F1 exposes the weak neutral
      class honestly.
    </figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Confusion matrix">
    <img
      src="/assets/projects/sriwijayaair-review-sentiment/confusion-matrix.webp"
      width="1400"
      height="833"
      loading="lazy"
      decoding="async"
      alt="Confusion matrix of the best model on the held-out test set"
    />
    <figcaption>
      Held-out confusion matrix: negative and positive separate cleanly, neutral
      gets absorbed by both.
    </figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Complaint signals">
    <img
      src="/assets/projects/sriwijayaair-review-sentiment/negative-review-signals.webp"
      width="1400"
      height="846"
      loading="lazy"
      decoding="async"
      alt="Bar chart of the most frequent terms in negative reviews: promo, tiket, member, buka, loading, and check-in related terms"
    />
    <figcaption>
      Negative reviews cluster around promos, ticketing, membership, and the app
      failing to open.
    </figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Error analysis">
    <img
      src="/assets/projects/sriwijayaair-review-sentiment/error-analysis.webp"
      width="1400"
      height="783"
      loading="lazy"
      decoding="async"
      alt="Error analysis summary showing which classes the model confuses on the held-out test set"
    />
    <figcaption>
      Error analysis on the held-out split: most mistakes involve the ambiguous
      neutral class.
    </figcaption>
  </figure>
</div>
