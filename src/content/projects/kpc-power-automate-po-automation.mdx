...
<figure className="evidence-panel" data-artifact="Intake form">
  <img
    src="/assets/projects/kpc-power-automate-po-automation/screenshots/01-microsoft-forms-po-request.webp"
    width="830"
    height="466"
    loading="lazy"
    decoding="async"
    alt="Microsoft Forms page for Pengajuan Personil Pengawas Operasional at PT Kaltim Prima Coal"
  />
  <figcaption>
    Microsoft Forms became the request entry point for internal personnel and
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel" data-artifact="Intake automation">
    <img
      src="/assets/projects/kpc-power-automate-po-automation/screenshots/04-power-automate-intake-document-check-flow.webp"
      width="356"
      height="773"
      loading="lazy"
      decoding="async"
      alt="Power Automate flow for Microsoft Forms intake, SharePoint item creation, document matching, and invalid submission handling"
    />
    <figcaption>
      Power Automate orchestrated form response intake, SharePoint item
      creation, folder lookup, document matching, ZIP extraction, share-link
      creation, and invalid-submission handling.
    </figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Approval branch">
    <img
      src="/assets/projects/kpc-power-automate-po-automation/screenshots/05-power-automate-hse-approval-b-simpel-flow.webp"
      width="352"
      height="785"
      loading="lazy"
      decoding="async"
      alt="Power Automate approval flow for HSE validation, Word template generation, PDF conversion, B-Simpel routing, and email notification"
    />
    <figcaption>
      The approval branch handled HSE decisions, generated Word/PDF appointment
      documents, updated final status, routed approved folders to B-Simpel, and
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel" data-artifact="Status database">
    <img
      src="/assets/projects/kpc-power-automate-po-automation/screenshots/02-sharepoint-list-po-database.webp"
      width="1400"
      height="669"
      loading="lazy"
      decoding="async"
      alt="SharePoint List used as the database for CMD operational supervisor appointment requests"
    />
    <figcaption>
      SharePoint List stored request records, status fields, document links, and
      generated identifiers.
    </figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Distribution">
    <img
      src="/assets/projects/kpc-power-automate-po-automation/screenshots/03-b-simpel-document-distribution.webp"
      width="1105"
      height="525"
      loading="lazy"
      decoding="async"
      alt="B-Simpel SharePoint portal showing distributed operational supervisor appointment document and five attachments"
    />
    <figcaption>
      Approved document folders were routed into B-Simpel with the appointment
      letter and required attachments.
    </figcaption>
  </figure>
</div>
