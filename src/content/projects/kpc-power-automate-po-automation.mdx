...
links: []
featured: true
coverImage: "/assets/projects/kpc-power-automate-po-automation/screenshots/02-sharepoint-list-po-database.png"
...
<figure className="evidence-panel">
  <img src="/assets/projects/kpc-power-automate-po-automation/screenshots/01-microsoft-forms-po-request.png" alt="Microsoft Forms page for Pengajuan Personil Pengawas Operasional at PT Kaltim Prima Coal" />
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-power-automate-po-automation/screenshots/04-power-automate-intake-document-check-flow.png" alt="Power Automate flow for Microsoft Forms intake, SharePoint item creation, document matching, and invalid submission handling" />
  ...
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-power-automate-po-automation/screenshots/05-power-automate-hse-approval-b-simpel-flow.png" alt="Power Automate approval flow for HSE validation, Word template generation, PDF conversion, B-Simpel routing, and email notification" />
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-power-automate-po-automation/screenshots/02-sharepoint-list-po-database.png" alt="SharePoint List used as the database for CMD operational supervisor appointment requests" />
    <figcaption>SharePoint List stored request records, status fields, document links, and generated identifiers.</figcaption>
  </figure>
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-power-automate-po-automation/screenshots/03-b-simpel-document-distribution.png" alt="B-Simpel SharePoint portal showing distributed operational supervisor appointment document and five attachments" />
