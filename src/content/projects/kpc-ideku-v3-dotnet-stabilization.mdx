...
links: []
featured: true
coverImage: "/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/04-power-bi-report.png"
...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/01-help-hub.png" alt="IdeKU V3 Help Hub page with guide categories for idea submission, innovation exploration, and approval review" />
    <figcaption>Help Hub grouped user guidance into business-process categories.</figcaption>
  </figure>
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/02-guided-tour.png" alt="IdeKU V3 Guided Tour active on My Ideas page with contextual tooltip" />
    <figcaption>Guided Tour highlighted UI elements with contextual step-by-step guidance.</figcaption>
  </figure>
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/03-resend-approval.png" alt="IdeKU V3 Resend Approval Notification page" />
    <figcaption>Resend Approval gave users manual control over missed approval notifications.</figcaption>
  </figure>
  <figure className="evidence-panel">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/04-power-bi-report.png" alt="IdeKU V3 Power BI report page embedded inside the application" />
