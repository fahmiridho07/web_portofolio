...
<div className="evidence-grid evidence-grid-2">
  <figure className="evidence-panel" data-artifact="Help hub">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/01-help-hub.webp" width="1386" height="665" loading="lazy" decoding="async" alt="IdeKU V3 Help Hub page with guide categories for idea submission, innovation exploration, and approval review" />
    <figcaption>Help Hub grouped user guidance into business-process categories.</figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Guided tour">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/02-guided-tour.webp" width="1244" height="597" loading="lazy" decoding="async" alt="IdeKU V3 Guided Tour active on My Ideas page with contextual tooltip" />
    <figcaption>Guided Tour highlighted UI elements with contextual step-by-step guidance.</figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Resend approval">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/03-resend-approval.webp" width="1400" height="673" loading="lazy" decoding="async" alt="IdeKU V3 Resend Approval Notification page" />
    <figcaption>Resend Approval gave users manual control over missed approval notifications.</figcaption>
  </figure>
  <figure className="evidence-panel" data-artifact="Embedded analytics">
    <img src="/assets/projects/kpc-ideku-v3-dotnet-stabilization/screenshots/04-power-bi-report.webp" width="1257" height="604" loading="lazy" decoding="async" alt="IdeKU V3 Power BI report page embedded inside the application" />
    <figcaption>Power BI Embedded added analytics pages directly inside IdeKU V3.</figcaption>
  </figure>
</div>
